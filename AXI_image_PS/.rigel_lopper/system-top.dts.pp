# 1 "C:\\work\\github\\AXI_image\\AXI_image_PS\\platform\\hw\\sdt\\system-top.dts"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:\\work\\github\\AXI_image\\AXI_image_PS\\platform\\hw\\sdt\\system-top.dts"
/dts-v1/;
# 1 "C:\\work\\github\\AXI_image\\AXI_image_PS\\platform\\hw\\sdt\\zynq-7000.dtsi" 1
# 10 "C:\\work\\github\\AXI_image\\AXI_image_PS\\platform\\hw\\sdt\\zynq-7000.dtsi"
/ {
 #address-cells = <1>;
 #size-cells = <1>;
...
# 3 "C:\\work\\github\\AXI_image\\AXI_image_PS\\platform\\hw\\sdt\\system-top.dts" 2
# 1 "C:\\work\\github\\AXI_image\\AXI_image_PS\\platform\\hw\\sdt\\pl.dtsi" 1
/ {
 amba_pl: amba_pl {
  ranges;
  compatible = "simple-bus";
  ...
  my_image_ip_0: my_image_ip@43c00000 {
   xlnx,s00-axi-data-width = <32>;
   compatible = "xlnx,my-image-ip-1.0";
   status = "okay";
   clock-names = "m00_axis_aclk" , "s00_axi_aclk" , "s00_axis_aclk";
   xlnx,s00-axi-addr-width = <4>;
   xlnx,ip-name = "my_image_ip";
   xlnx,edk-iptype = "PERIPHERAL";
   reg = <0x43c00000 0x10000>;
   clocks = <&clkc 15>, <&clkc 15>, <&clkc 15>;
   xlnx,name = "my_image_ip_0";
  };
 };
};
# 4 "C:\\work\\github\\AXI_image\\AXI_image_PS\\platform\\hw\\sdt\\system-top.dts" 2
# 1 "C:\\work\\github\\AXI_image\\AXI_image_PS\\platform\\hw\\sdt\\pcw.dtsi" 1
 &ps7_cortexa9_0 {
 ...
 &amba {
  processing_system7_0: processing_system7@0 {
   ...
   xlnx,pcw-package-ddr-dqs-to-clk-delay-0 = <0xffff3cb0>;
   xlnx,pcw-uiparam-ddr-dqs-3-length-mm = <0x1c09bc0>;
   xlnx,pcw-package-ddr-dqs-to-clk-delay-1 = <0xffff5420>;
   xlnx,pcw-qspi-grp-single-ss-enable = <1>;
   xlnx,pcw-act-usb0-peripheral-freqmhz = <60>;
   xlnx,pcw-mio-27-pullup = "enabled";
   xlnx,pcw-package-ddr-dqs-to-clk-delay-2 = <0xffff7748>;
   xlnx,pcw-mio-38-direction = "inout";
   xlnx,pcw-package-ddr-dqs-to-clk-delay-3 = <0xfffe7960>;
   xlnx,pcw-en-spi0 = <0>;
   xlnx,pcw-en-spi1 = <0>;
   ...
   xlnx,pcw-uiparam-ddr-dqs-2-length-mm = <0x15d6d20>;
   ...
   xlnx,pcw-uiparam-ddr-dq-3-length-mm = <0x1c09bc0>;
   ...
   xlnx,pcw-package-ddr-board-delay0 = <0x35f48>;
   xlnx,pcw-wdt-peripheral-divisor0 = <1>;
   xlnx,s-axi-hp1-data-width = <64>;
   xlnx,pcw-package-ddr-board-delay1 = <0x36330>;
   xlnx,pcw-package-ddr-board-delay2 = <0x34fa8>;
   ...
   xlnx,pcw-package-ddr-board-delay3 = <0x3b920>;
   ...
   xlnx,pcw-uiparam-ddr-clock-3-length-mm = <0x11edd80>;
   ...
   xlnx,pcw-uiparam-ddr-dqs-1-length-mm = <0x1a9b860>;
   ...
   xlnx,pcw-uiparam-ddr-dq-2-length-mm = <0x15d6d20>;
   ...
   xlnx,pcw-uiparam-ddr-clock-2-length-mm = <0x11edd80>;
   ...
   xlnx,pcw-uiparam-ddr-dqs-0-length-mm = <0x15be680>;
   ...
   xlnx,pcw-uiparam-ddr-dq-1-length-mm = <0x1a9b860>;
   ...
   xlnx,pcw-uiparam-ddr-clock-1-length-mm = <0x11edd80>;
   ...
   xlnx,pcw-uiparam-ddr-dq-0-length-mm = <0x15be680>;
   ...
   xlnx,pcw-uiparam-ddr-clock-0-length-mm = <0x11edd80>;
   ...
   xlnx,pcw-mio-tree-peripherals = "GPIO#Quad , SPI , Flash#Quad , SPI , Flash#Quad , SPI , Flash#Quad , SPI , Flash#Quad , SPI , Flash#Quad , SPI , Flash#GPIO#Quad , SPI , Flash#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#Enet , 0#Enet , 0#Enet , 0#Enet , 0#Enet , 0#Enet , 0#Enet , 0#Enet , 0#Enet , 0#Enet , 0#Enet , 0#Enet , 0#USB , 0#USB , 0#USB , 0#USB , 0#USB , 0#USB , 0#USB , 0#USB , 0#USB , 0#USB , 0#USB , 0#USB , 0#SD , 0#SD , 0#SD , 0#SD , 0#SD , 0#SD , 0#USB , Reset#SD , 0#UART , 1#UART , 1#GPIO#GPIO#Enet , 0#Enet , 0";
...
# 5 "C:\\work\\github\\AXI_image\\AXI_image_PS\\platform\\hw\\sdt\\system-top.dts" 2
/ {
 board = "zybo-z7-20";
 ...
 cpus_a9: cpus-a9@0 {
  ...
  address-map = <0xf0000000 &amba 0xf0000000 0x10000000>,
         ...
         <0x43c00000 &my_image_ip_0 0x43c00000 0x10000>,
