...
HD_PWD='C:/work/github/AXI_image/AXI_image/AXI_image.runs/design_1_my_image_ip_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_my_image_ip_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_my_image_ip_0_0.tcl
