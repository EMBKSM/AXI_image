...
REM
REM Generated by Vivado on Mon Dec 15 13:03:38 +0900 2025
...
echo "xvlog --incr --relax -L uvm -prj tb_myip_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_myip_vlog.prj -log xvlog.log
